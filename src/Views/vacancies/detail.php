...
<head>
    ...
    <style>
        ...
        .company-badge-large img { width: 100%; height: 100%; object-fit: cover; }
...
<body class="animate">
    ...
    <!-- Local Navbar -->
    <nav class="glass animate" style="position: fixed; top: 1rem; left: 1rem; right: 1rem; height: 75px; display: flex; align-items: center; justify-content: space-between; padding: 0 2.5rem; z-index: 1000; border-radius: 20px;">
        <div class="d-flex align-items-center gap-2">
            <div class="sidebar-grid-icon" style="transform: scale(0.6);"><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span></div>
            <a href="/" class="logo-text m-0" style="text-decoration: none; font-size: 1.2rem;">StarTraining</a>
        </div>
        <div class="d-flex align-items-center gap-3">
            <a href="/" class="btn-ghost text-decoration-none small">Inicio</a>
            <a href="/login" class="btn-futuristic" style="padding: 0.6rem 1.5rem; font-size: 0.85rem;">Portal Empresa</a>
        </div>
    </nav>
        ...
        <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 1.5rem;">
            <div class="row d-flex gap-5">
                ...
                <div class="col-8">
                    ...
                    <h1 class="fw-800 mb-2" style="font-size: 2.2rem; letter-spacing: -1px;"><?= htmlspecialchars($v['titulo_puesto']) ?></h1>
                    <div class="d-flex gap-4 mb-5 text-muted small fw-600">
                        <span><i class="fas fa-building text-primary me-2"></i> <?= htmlspecialchars($v['nombre_comercial']) ?></span>
                        <span><i class="fas fa-map-marker-alt text-primary me-2"></i> <?= htmlspecialchars($v['ubicacion'] ?: 'Remoto / Perú') ?></span>
                    ...
                    <div class="glass-card mb-5 animate" style="padding: 2.5rem; border-radius: 25px;">
                        <h3 class="mb-4 fw-800" style="font-size: 1.1rem; text-transform: uppercase; letter-spacing: 1px;">Descripción</h3>
                        <p class="text-secondary lh-lg mb-5" style="white-space: pre-line;"><?= htmlspecialchars($v['descripcion_puesto']) ?></p>
                        
                        <h3 class="mb-4 fw-800" style="font-size: 1.1rem; text-transform: uppercase; letter-spacing: 1px;">Requisitos</h3>
                        <p class="text-secondary lh-lg" style="white-space: pre-line;"><?= htmlspecialchars($v['requisitos']) ?></p>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="d-flex flex-column gap-4" style="position: sticky; top: 100px;">
                        ...
                        <!-- Apply Card -->
                        <div class="glass-card animate" style="padding: 2.5rem; border-radius: 25px; border-top: 5px solid var(--primary);">
                            <h2 class="fw-800 mb-3" style="font-size: 1.25rem;">¿Deseas postular?</h2>
                            <p class="text-muted small mb-4">Envía tu CV y nuestra IA evaluará tu perfil al instante para la empresa.</p>
                            
                            <a href="/vacante/<?= $id ?>/postular" class="btn-futuristic w-100 py-3 mb-3 text-decoration-none">
                                <i class="fas fa-paper-plane me-2"></i> Postular Ahora
                            </a>
                            
                            <div class="d-flex align-items-center gap-3 p-3" style="background: rgba(59,130,246,0.06); border-radius: 12px;">
                        ...
                        <div class="glass-card animate" style="padding: 2rem; border-radius: 25px;">
                            ...
                            <p class="text-muted xsmall mb-3">Si ya postulaste, ingresa tu DNI para ver tu puntaje de match con esta vacante.</p>
                            
                            <div class="d-flex gap-2">
                                <input type="text" id="dniConsulta" class="form-input" placeholder="Ingresar DNI" maxlength="8" style="padding: 0.6rem 1rem; font-size: 0.85rem;">
                                <button onclick="consultarResultado()" id="btnConsultarRes" class="btn-futuristic" style="padding: 0 1rem;">
                            ...
                            <div id="resultadoDniWrap" style="display: none;" class="mt-4 pt-3 border-top">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <span id="resMatchPct" class="fw-900 text-primary" style="font-size: 1.2rem;">0%</span>
                                </div>
                                <div style="height: 6px; background: rgba(0,0,0,0.05); border-radius: 10px; overflow: hidden; margin-bottom: 1rem;">
                                    <div id="resMatchBar" style="height: 100%; width: 0%; background: var(--primary); transition: width 0.6s ease;"></div>
                                </div>
