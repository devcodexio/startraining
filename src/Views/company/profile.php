                ...
                <div class="row d-flex gap-4">
                    ...
                    <div class="col glass-card animate" style="animation-delay: 0.1s;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="telefono" class="form-input" value="<?= htmlspecialchars($c['telefono']) ?>" placeholder="987 654 321">
                        </div>

                        <div class="form-group mb-0">
                            <label class="form-label">Dirección Fiscal</label>
                            <input type="text" name="direccion" class="form-input" value="<?= htmlspecialchars($c['direccion']) ?>" placeholder="Av. Principal 123...">
                        </div>
                    </div>
                    ...
                    <div class="col-5 glass-card animate" style="animation-delay: 0.2s;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sector" class="form-input" value="<?= htmlspecialchars($c['sector']) ?>" required placeholder="Ej: Tecnología, Salud...">
                        </div>
                        ...
                        <div class="alert small text-muted p-3" style="background: rgba(59,130,246,0.05); border-radius: 12px; border: 1px solid rgba(59,130,246,0.1);">
                            ...
                            El RUC y la Razón Social son campos verificados y no pueden ser alterados.
                        </div>
